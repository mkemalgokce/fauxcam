---
name: clean-code
description: Use during everyday implementation and code review in this repo - shaping functions, naming, command/query separation, local reasoning, and keeping framework/persistence/vendor details behind boundaries. Derived from "Clean Code" (Robert C. Martin). Defers to the stricter /clean-naming and /comment-discipline skills on any naming or comment conflict. Full reference in reference.md.
---

# OBEY Clean Code by Robert C. Martin

> Precedence: `/clean-naming` and `/comment-discipline` are mandatory and stricter — they win on naming/comment conflicts. This skill supplements them.
