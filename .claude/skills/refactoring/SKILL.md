---
name: refactoring
description: Use for behavior-preserving cleanup of existing FauxCam code - preparatory or follow-up refactoring around a feature or bug fix, removing a blocking smell in small reversible steps without changing observable behavior. Derived from "Refactoring" (Martin Fowler). Full reference in reference.md.
---
